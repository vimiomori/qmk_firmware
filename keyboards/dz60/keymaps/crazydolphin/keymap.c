 ...
 */
	...
	[_DEFAULT] = LAYOUT_60_tsangan_hhkb(
	    ...
	    TG(_VIM),      KC_LALT,      KC_LGUI,                      KC_SPC,                    MO(_LIGHTS),           KC_RGUI,         MO(_MOUSE)),
 ...
 */
	...
	[_VIM] = LAYOUT_60_tsangan_hhkb(
		...
		______,          ______, ______, ______,  ______,   ______,  ______,  ______,  TG(_DEFAULT), ______, ______, ______, ______, ______,
